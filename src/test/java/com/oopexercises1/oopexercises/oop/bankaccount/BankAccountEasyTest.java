package com.oopexercises1.oopexercises.oop.bankaccount;

import com.oopexercises.oop.bankaccount.BankAccount;
import com.oopexercises.oop.bankaccount.BankAccountEasy;
import com.oopexercises.oop.bankaccount.BankAccountPro;
...
class BankAccountEasyTest {
    ...
    void transfer() {
        ...
        //test aggiunto per il trasferimento tra due conti tedeschi
        //assertDoesNotThrow(() -> bankAccount1.transfer(otherInternational, 500));
